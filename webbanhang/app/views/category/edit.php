...
<div class="container form-page">
    <div class="form-card">
        <div class="form-card-header">
            <i class="fas fa-folder-open"></i> Chỉnh sửa danh mục
        </div>
            ...
            <form method="POST" action="/webbanhang/Category/update">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control <?php echo isset($errors['name']) ? 'is-invalid' : ''; ?>"
                           value="<?php echo htmlspecialchars($_POST['name'] ?? $category->name, ENT_QUOTES); ?>"
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="4"
                              placeholder="Mô tả ngắn về danh mục này..."><?php echo htmlspecialchars($_POST['description'] ?? $category->description, ENT_QUOTES); ?></textarea>
                </div>
